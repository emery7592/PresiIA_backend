...
from sqlalchemy import Column, String, Integer, Boolean, DateTime, Enum, Numeric, ForeignKey
...
# NOUVEAUX ENUMS pour les paiements
...
# NOUVELLES CLASSES pour les paiements
